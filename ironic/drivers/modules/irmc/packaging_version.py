...
# note(JayF): Contents of this file come from https://github.com/pypa/packaging
# and were provided under a dual BSD/Apache license. It has been adapted
# for use here to prevent the need add additional libraries for released stable
# branches. Zed release and newer use the packaging library directly.
...
CmpKey = Tuple[
    int, Tuple[int, ...], PrePostDevType, PrePostDevType, PrePostDevType, LocalType  # noqa
]
