...
class TestFormatInspectors(test_base.TestCase):
    ...
    # NOTE(TheJulia): Disabling test because we have high confidence in the
    # underlying code, and this (and some other tests) can put a lot of
    # load on the host to run, and sometimes these tests can timeout.
